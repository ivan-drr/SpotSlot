...
const init = () => {
  console.group('%c%c⊢☵☵☵☵☵☵┤ 𝙇𝙚𝙜𝙚𝙣𝙙 ├☵☵☵☵☵☵⊣', '', 'color:#1E799E; font-size:1.3em; text-shadow: 3px 2px #CDCDCD;');
    console.info('%c☉  %c=  %cPinpoint info', 'font-size: 2em', 'color:black; font-size: 1.5em' , 'color:#598ED1');
    console.info('%c☀  %c=  %cCorrect app flow', 'font-size: 2em', 'color:black; font-size: 1.5em' , 'color:#1E9E65');
    console.info('%c☂  %c=  %cWarning it may rain', 'font-size: 2em', 'color:black; font-size: 1.5em' , 'color:#aca94f');
